defmodule SlaxWeb.ChatRoomLive do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col shrink-0 w-64 bg-slate-100">
      ...
      <div class="mt-4 overflow-auto">
        <div class="flex items-center h-8 px-3">
          <span class="ml-2 leading-none front-medium text-sm">Rooms</span>
        </div>
        <div id="rooms-list">
    ...
    <div class="flex flex-col grow shadow-lg">
      <div class="flx justify-between items-center shrink-0 h-16 bg-white border-b border-slate-300 px-4">
        <div class="flex flex-col gap-1.5">
